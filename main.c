...
wrong_id:
        ...
        if(strcmp(id,"rahat")==0 || strcmp(id,"wasif")==0)
        {
wrong_pass:
...
w:
                ...
                if(i==0||fread(&p,recsize,1,fp)==0)
                {
                    ...
                    else
                    {
                        ...
                        gets(p.history);
                        fflush(stdin);
                        printf("\nEnter the duration of treatment(days/weeks/months/years):");
                        scanf("%s",p.date);
                        fflush(stdin);
                        printf("\nTreatment Given:");
                        scanf("%s",p.treatment);
...
out:
            ...
            while(another=='Y'||another=='y')
            {
                ...
                while(fread(&p,recsize,1,fp)==1)
                {
                    if(strcmp(p.regn,reg)==0)
                    {
                        ...
                        scanf("%s",p.ph);
                        fflush(stdin);
                        printf("enter the duration of treatment given: ");
                        gets(p.date);
        ...
        case '4':
            ...
            while(fread(&p,recsize,1,fp)==1)
            {
                ...
                puts(p.history);
                printf("\nDetails of treatment given and medicine prescribed:");
                printf("\nDURATION\t\t TREATMENT GIVEN\t\t\t MEDICINE PRESCRIBED\n");
                printf("%s\t\t %s\t\t\t %s\n",p.date,p.treatment,p.med);
                printf("\nName of the Doctor : ");
                puts(p.doc_name);
                printf("\n----------------------------------------------------\n");
